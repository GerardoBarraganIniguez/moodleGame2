...
@section('css')
    rel="stylesheet" href="/css/createexam.css"
@endsection
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
        <h5 style="padding-top: 15px">Crear exámen</h5>
        <p>Seleccione el no. de preguntas que desea agregar:</p>
    ...
    <form>
        <button type="submit" class="btn btn-primary mt-3 float-left">Enviar</button>
    </form> 
    </div>
  </div>
</div>
      ...
      for (let i = 0; i < numBoxesInput.value; i++) {
        ...
        const textBox = `
            <div class="form-group">
                <label for="text-box-${i + 1}">Pregunta no.${i + 1}</label>
                <textarea class="form-control" id="text-box-${i + 1}" rows="3" style="max-height: 5px;"></textarea>
            </div>
        `;
